...
struct fb_ops {
	...
	void (*fb_clear) (struct fb_info *, u32);
	void (*fb_point) (struct fb_info *, short,short, u32, char);
	void (*fb_hline) (struct fb_info *,short,short,short,u32);
	void (*fb_vline) (struct fb_info *,short,short,short,u32);
	...
	//u32 (*fb_getpixels_rgb2) (struct fb_info *, short,short,short,unsigned long*,char);
