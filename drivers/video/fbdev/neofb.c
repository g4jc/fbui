...
void neofb_fillrect2 (struct fb_info *info, struct fb_draw *p)
{
	...
	if (y0 < 0)
		y0 = 0;
	if ((u32)x0 >= info->var.xres)
		x0 = info->var.xres - 1;
	if ((u32)y0 >= info->var.yres)
		y0 = info->var.yres - 1;
	if (p->clip_valid) {
		if (x0 > p->clip_x1 || x1 < p->clip_x0 ||
		    y0 > p->clip_y1 || y1 < p->clip_y0)
			return;
		if (x0 < p->clip_x0)
			x0 = p->clip_x0;
		if (y0 < p->clip_y0)
...
static struct fb_ops neofb_ops = {
	...
	.fb_imageblit	= neofb_imageblit,
        ...
        .fb_line                = generic_line,
        .fb_filltriangle	= generic_filltriangle,
        .fb_putimage		= generic_putimage,
        .fb_fillrect2		= neofb_fillrect2,
        .fb_copyarea2           = 0,
